...
{
    public partial class InvoicePOS : Form
    {
        ...
        private void InvoicePOS_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.SetParameters(new ReportParameter[] { companyName, companyAddr, companyph, companyimage, water,bCode,checkString ,checklogoString,devName,devPh});
